...
std::string UnifiedCommandConvertorRecorder::getCommandFromProgramArgs( const std::map<common_types::TCommandLineArgKey, common_types::TCommandLineArgVal> & _args ){

    assert( false && "TODO: do" );
}

std::string UnifiedCommandConvertorRecorder::getCommandFromConfigFile( const std::string & _command ){
...
std::string UnifiedCommandConvertorRecorder::getCommandFromHTTPRequest( const std::string & _httpMethod,
