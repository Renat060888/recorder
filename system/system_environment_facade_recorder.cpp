...
#include "system_environment_facade_recorder.h"

using namespace std;
using namespace common_types;

static constexpr const char * PRINT_HEADER = "SystemEnvironmentRecorder:";

SystemEnvironmentFacadeRecorder::SystemEnvironmentFacadeRecorder()
{
...
bool SystemEnvironmentFacadeRecorder::init( const SInitSettings & _settings ){
